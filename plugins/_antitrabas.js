...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '56993761200-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '*ElmoBot*', 'jpegThumbnail': null } } };
